...
var $f6c31cce2adf654f$var$LINK_CLICKED = /* @__PURE__ */ Symbol("linkClicked");
...
function o2() {
  let s20 = [], r22 = { addEventListener(e9, t14, n17, i16) {
...
// node_modules/@headlessui/react/dist/hooks/use-latest-value.js
function s3(e9) {
  let r22 = (0, import_react43.useRef)(e9);
  return n(() => {
    r22.current = e9;
  }, [e9]), r22;
}
...
var o4 = function(t14) {
  let e9 = s3(t14);
  return import_react44.default.useCallback((...r22) => e9.current(...r22), [e9]);
};
...
function w({ disabled: e9 = false } = {}) {
  let t14 = (0, import_react45.useRef)(null), [n17, l19] = (0, import_react45.useState)(false), r22 = p(), o20 = o4(() => {
...
function F(n17, r22 = {}, e9, a28, s20) {
  ...
  if (r22) {
    let d14 = false, p13 = [];
    for (let [c21, T10] of Object.entries(r22)) typeof T10 == "boolean" && (d14 = true), T10 === true && p13.push(c21.replace(/([A-Z])/g, (g6) => `-${g6.toLowerCase()}`));
    if (d14) {
...
function P2(...n17) {
  ...
  let r22 = {}, e9 = {};
  for (let s20 of n17) for (let t14 in s20) t14.startsWith("on") && typeof s20[t14] == "function" ? ((a28 = e9[t14]) != null || (e9[t14] = []), e9[t14].push(s20[t14])) : r22[t14] = s20[t14];
  if (r22.disabled || r22["aria-disabled"]) for (let s20 in e9) /^(on(?:Click|Pointer|Mouse|Key)(?:Down|Up|Press)?)$/.test(s20) && (e9[s20] = [(t14) => {
    var l19;
    return (l19 = t14 == null ? void 0 : t14.preventDefault) == null ? void 0 : l19.call(t14);
  }]);
  for (let s20 in e9) Object.assign(r22, { [s20](t14, ...l19) {
    let i16 = e9[s20];
    for (let o20 of i16) {
...
function V(...n17) {
  ...
  let r22 = {}, e9 = {};
  for (let s20 of n17) for (let t14 in s20) t14.startsWith("on") && typeof s20[t14] == "function" ? ((a28 = e9[t14]) != null || (e9[t14] = []), e9[t14].push(s20[t14])) : r22[t14] = s20[t14];
  for (let s20 in e9) Object.assign(r22, { [s20](...t14) {
    let l19 = e9[s20];
...
function Y(n17) {
  var r22;
  return Object.assign((0, import_react48.forwardRef)(n17), { displayName: (r22 = n17.displayName) != null ? r22 : n17.name });
}
function m2(n17) {
...
function b(n17) {
  return n17 === import_react48.Fragment || n17 === /* @__PURE__ */ Symbol.for("react.fragment");
}
function D(n17) {
  return b(n17.type);
}
...
function W(t14) {
  let [e9, r22] = (0, import_react53.useState)(null);
  return import_react53.default.createElement(f5.Provider, { value: { target: e9 } }, t14.children, import_react53.default.createElement(f4, { features: s5.Hidden, ref: r22 }));
}
function c3({ children: t14 }) {
  ...
  let { target: r22 } = e9;
  return r22 ? (0, import_react_dom4.createPortal)(import_react53.default.createElement(import_react53.default.Fragment, null, t14), r22) : null;
}
function j2({ data: t14, form: e9, disabled: r22, onReset: n17, overrides: F7 }) {
  ...
  }, [i16, e9, n17]), import_react53.default.createElement(c3, null, import_react53.default.createElement(C2, { setForm: a28, formId: e9 }), p2(t14).map(([s20, v11]) => import_react53.default.createElement(f4, { features: s5.Hidden, ...m2({ key: s20, as: "input", type: "hidden", hidden: true, readOnly: true, form: e9, disabled: r22, name: s20, value: v11, ...F7 }) })));
}
function C2({ setForm: t14, formId: e9 }) {
  ...
  }, [t14, e9]), e9 ? null : import_react53.default.createElement(f4, { features: s5.Hidden, as: "input", type: "hidden", hidden: true, readOnly: true, ref: (r22) => {
    if (!r22) return;
...
function f6({ id: t14, children: r22 }) {
  return import_react54.default.createElement(e3.Provider, { value: t14 }, r22);
}
...
function f7() {
  let r22 = (0, import_react56.useContext)(a7);
  if (r22 === null) {
...
function w3() {
  var r22, e9;
  return (e9 = (r22 = (0, import_react56.useContext)(a7)) == null ? void 0 : r22.value) != null ? e9 : void 0;
}
function H3() {
  let [r22, e9] = (0, import_react56.useState)([]);
  return [r22.length > 0 ? r22.join(" ") : void 0, (0, import_react56.useMemo)(() => function(t14) {
...
var I2 = "p";
function C3(r22, e9) {
  let c21 = (0, import_react51.useId)(), t14 = a3(), { id: i16 = `headlessui-description-${c21}`, ...l19 } = r22, n17 = f7(), o20 = y(e9);
...
var de = "span";
function pe(u25, b14) {
  let f21 = (0, import_react51.useId)(), y10 = u4(), T10 = a3(), { id: h15 = y10 || `headlessui-checkbox-${f21}`, disabled: o20 = T10 || false, autoFocus: i16 = false, checked: C11, defaultChecked: k13, onChange: x10, name: d14, value: g6, form: E13, indeterminate: l19 = false, tabIndex: v11 = 0, ...P8 } = u25, r22 = l3(k13), [a28, t14] = b2(C11, x10, r22 != null ? r22 : false), D12 = N(), R7 = w3(), A5 = p(), [F7, p13] = (0, import_react58.useState)(false), c21 = o4(() => {
...
function u9(e9 = l8) {
  return (0, import_react61.useCallback)((r22, t14) => {
    if (typeof e9 == "string") {
      let o20 = e9;
...
function w5(i16, t14, e9 = false) {
  let [r22, f21] = (0, import_react62.useState)(() => h3(t14));
  return n(() => {
    if (!t14 || !i16) return;
    let n17 = o2();
...
// node_modules/@headlessui/react/dist/hooks/use-handle-toggle.js
function s8(t14) {
  let r22 = (0, import_react63.useRef)(null), u25 = o4((e9) => {
...
var u10 = (t14, e9, r22, s20) => (b3(t14, e9, "write to private field"), s20 ? s20.call(t14, r22) : e9.set(t14, r22), r22);
var n9;
var a9;
var o9;
var T3 = class {
  ...
  subscribe(e9, r22) {
    ...
    let s20 = { selector: e9, callback: r22, current: e9(i7(this, n9)) };
...
function f8(t14, e9) {
  do {
    let r22 = t14.next(), s20 = e9.next();
    if (r22.done && s20.done) return true;
    if (r22.done || s20.done || !Object.is(r22.value, s20.value)) return false;
  } while (true);
}
function p3(t14) {
  if (Object.prototype.toString.call(t14) !== "[object Object]") return false;
...
function k3(t14) {
  let [e9, r22] = t14(), s20 = o2();
  return (...l19) => {
    e9(...l19), s20.dispose(), s20.microTask(r22);
  };
}
...
// node_modules/@headlessui/react/dist/hooks/use-is-top-layer.js
function I3(o20, s20) {
  let t14 = (0, import_react64.useId)(), r22 = x2.get(s20), [i16, c21] = S3(r22, (0, import_react64.useCallback)((e9) => [r22.selectors.isTop(e9, t14), r22.selectors.inStack(e9, t14)], [r22, t14]));
  return n(() => {
...
function y4(t14, { allowed: r22, disallowed: e9 } = {}) {
  ...
  n(() => {
    ...
    let s20 = (c21 = r22 == null ? void 0 : r22()) != null ? c21 : [];
    for (let n17 of s20) {
      if (!n17) continue;
      let l19 = l(n17);
      if (!l19) continue;
...
function v5(e9, r22, { sorted: t14 = true, relativeTo: l19 = null, skipElements: n17 = [] } = {}) {
  ...
  let o20 = (() => {
    ...
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), N4 = r22 & 32 ? { preventScroll: true } : {}, m10 = 0, c21 = u25.length, s20;
  do {
  ...
  return r22 & 6 && P3(s20) && s20.select(), 2;
}
...
function c6(...e9) {
  return (0, import_react69.useMemo)(() => r3(...e9), [...e9]);
}
...
var M3 = 200;
var f10 = 5;
function L4(r22, { trigger: n17, action: T10, close: e9, select: p13 }) {
...
function c8(u25 = 0) {
  let [r22, a28] = (0, import_react76.useState)(u25), g6 = (0, import_react76.useCallback)((e9) => a28(e9), []), s20 = (0, import_react76.useCallback)((e9) => a28((l19) => l19 | e9), []), m10 = (0, import_react76.useCallback)((e9) => (r22 & e9) === e9, [r22]), n17 = (0, import_react76.useCallback)((e9) => a28((l19) => l19 & ~e9), []), F7 = (0, import_react76.useCallback)((e9) => a28((l19) => l19 ^ e9), []);
  return { flags: r22, setFlag: g6, addFlag: s20, hasFlag: m10, removeFlag: n17, toggleFlag: F7 };
}
...
function N2(e9, r22, t14, n17) {
  ...
  }, [e9, t14, r22, E13]), e9 ? [i16, { closed: s20(1), enter: s20(2), leave: s20(4), transition: s20(2) || s20(4) }] : [t14, { closed: void 0, enter: void 0, leave: void 0, transition: void 0 }];
}
...
function F2(c21, { container: e9, accept: t14, walk: r22 }) {
  let o20 = (0, import_react78.useRef)(t14), l19 = (0, import_react78.useRef)(r22);
...
function m7(u25, t14) {
  let e9 = (0, import_react79.useRef)([]), r22 = o4(u25);
...
function Re(e9 = null) {
  ...
  let r22 = (0, import_react83.useContext)(y5);
  return (0, import_react83.useMemo)(() => [r22.setFloating, e9 ? r22.styles : {}], [r22.setFloating, e9, r22.styles]);
}
var D5 = 4;
function Ae({ children: e9, enabled: t14 = true }) {
  let [n17, r22] = (0, import_react83.useState)(null), [l19, o20] = (0, import_react83.useState)(0), u25 = (0, import_react83.useRef)(null), [f21, s20] = (0, import_react83.useState)(null);
  ce(f21);
  ...
  return j6.createElement($2.Provider, { value: r22 }, j6.createElement(y5.Provider, { value: { setFloating: Y4, setReference: b14.setReference, styles: S10, getReferenceProps: Q7, getFloatingProps: X5, slot: G6 } }, e9));
}
function ce(e9) {
  n(() => {
    if (!e9) return;
    ...
    if (typeof s20 == "string") {
      ...
      return [F7, (E13) => {
        let A5 = q(s20);
        {
          ...
          r22.requestAnimationFrame(function h15() {
            r22.nextFrame(h15);
            let a28 = false;
...
function f14(l19, n17) {
  ...
  let r22 = n17.resolveActiveIndex(), s20 = r22 != null ? r22 : -1;
  switch (l19.focus) {
    case 0: {
...
function c13(t14) {
  let r22 = o4(t14), e9 = (0, import_react86.useRef)(false);
...
// node_modules/@headlessui/react/dist/components/portal/portal.js
function W2(e9) {
  let o20 = a17(), l19 = (0, import_react88.useContext)(c15), [r22, p13] = (0, import_react88.useState)(() => {
    var s20;
  ...
  }, [r22, e9]), (0, import_react88.useEffect)(() => {
    o20 || l19 !== null && p13(l19.current);
  }, [l19, p13, o20]), r22;
}
var _4 = import_react88.Fragment;
var j7 = Y(function(o20, l19) {
  let { ownerDocument: r22 = null, ...p13 } = o20, t14 = (0, import_react88.useRef)(null), n17 = y(T((a28) => {
    t14.current = a28;
  }), l19), s20 = u13(t14.current), C11 = r22 != null ? r22 : s20, u25 = W2(C11), y10 = (0, import_react88.useContext)(m8), g6 = p(), v11 = K();
  return c13(() => {
    var a28;
...
function S7(e9, o20) {
  ...
  return r22 ? import_react88.default.createElement(j7, { ...t14, ownerDocument: p13, ref: l19 }) : n17({ ourProps: { ref: l19 }, theirProps: t14, slot: {}, defaultTag: _4, name: "Portal" });
}
var I5 = import_react88.Fragment;
var c15 = (0, import_react88.createContext)(null);
function D6(e9, o20) {
  let { target: l19, ...r22 } = e9, t14 = { ref: y(o20) }, n17 = K();
  return import_react88.default.createElement(c15.Provider, { value: l19 }, n17({ ourProps: t14, theirProps: r22, defaultTag: I5, name: "Popover.Group" }));
}
var m8 = (0, import_react88.createContext)(null);
function ee() {
  let e9 = (0, import_react88.useContext)(m8), o20 = (0, import_react88.useRef)([]), l19 = o4((t14) => (o20.current.push(t14), e9 && e9.register(t14), () => r22(t14))), r22 = o4((t14) => {
    let n17 = o20.current.indexOf(t14);
    n17 !== -1 && o20.current.splice(n17, 1), e9 && e9.unregister(t14);
  }), p13 = (0, import_react88.useMemo)(() => ({ register: l19, unregister: r22, portals: o20 }), [l19, r22, o20]);
      ...
      if (e10.defaultToFirstOption && e10.activeOptionIndex === null && (e10.virtual ? e10.virtual.options.length > 0 : e10.options.length > 0)) {
        if (e10.virtual) {
          let { options: o20, disabled: r22 } = e10.virtual, u25 = o20.findIndex((a28) => {
            var s20;
            return !((s20 = r22 == null ? void 0 : r22(a28)) != null && s20);
          });
          if (u25 !== -1) return u25;
        }
...
function w8(o20, t14) {
  ...
  }), v11 = I3(!!(s20 & 2), "focus-trap#tab-lock"), N4 = p(), b14 = (0, import_react96.useRef)(false), k13 = { ref: r22, onKeyDown(c21) {
...
function Te2(e9, t14) {
  let n17 = s3(e9), l19 = (0, import_react97.useRef)([]), S10 = f17(), R7 = p(), d14 = o4((o20, i16 = C.Hidden) => {
    ...
    C11.current.splice(0), t14 && (t14.chains.current[i16] = t14.chains.current[i16].filter(([s20]) => s20 !== o20)), t14 == null || t14.chains.current[i16].push([o20, new Promise((s20) => {
      ...
      Promise.all(h15.current[i16].map(([r22, f21]) => f21)).then(() => s20());
    })]), i16 === "enter" ? p13.current = p13.current.then(() => t14 == null ? void 0 : t14.wait.current).then(() => a28(i16)) : a28(i16);
  }), v11 = o4((o20, i16, a28) => {
    Promise.all(h15.current[i16].splice(0).map(([s20, r22]) => r22)).then(() => {
      var s20;
...
function Ie(e9, t14) {
  ...
  return import_react97.default.createElement(w9.Provider, { value: v11 }, import_react97.default.createElement(V3.Provider, { value: s20 }, H9({ ourProps: { ...r22, as: import_react97.Fragment, children: import_react97.default.createElement(me2, { ref: C11, ...r22, ...R7, beforeEnter: f21, beforeLeave: U3 }) }, theirProps: {}, defaultTag: import_react97.Fragment, features: fe, visible: h15 === "visible", name: "Transition" })));
}
function Le2(e9, t14) {
...
var z = Y(function(t14, o20) {
  ...
  let T10 = (0, import_react98.useRef)(null), I10 = y(T10, o20), F7 = u13(T10.current), c21 = i16 ? 0 : 1, [b14, Q7] = (0, import_react98.useReducer)(He2, { titleId: null, descriptionId: null, panelRef: (0, import_react98.createRef)() }), m10 = o4(() => p13(false)), B2 = o4((r22) => Q7({ type: 0, id: r22 })), D12 = l15() ? c21 === 0 : false, [Z4, ee7] = ee(), te6 = { get current() {
    var r22;
    return (r22 = b14.panelRef.current) != null ? r22 : T10.current;
  ...
  y4(u25 || U3 ? false : D12, { allowed: o4(() => {
    var r22, W5;
    return [(W5 = (r22 = T10.current) == null ? void 0 : r22.closest("[data-headlessui-portal]")) != null ? W5 : null];
  }), disallowed: o4(() => {
    var r22;
  ...
  let H9 = S3(P8, (0, import_react98.useCallback)((r22) => P8.selectors.isTop(r22, n17), [P8, n17]));
  k5(H9, M12, (r22) => {
...
function Se(e9, t14) {
  let { defaultOpen: l19 = false, ...p13 } = e9, a28 = (0, import_react100.useRef)(null), c21 = y(t14, T((u25) => {
    a28.current = u25;
  }, e9.as === void 0 || b(e9.as))), n17 = (0, import_react100.useReducer)(Pe, { disclosureState: l19 ? 0 : 1, buttonElement: null, panelElement: null, buttonId: null, panelId: null }), [{ disclosureState: o20, buttonId: r22 }, f21] = n17, s20 = o4((u25) => {
    f21({ type: 1 });
...
var ge5 = "button";
function Ae4(e9, t14) {
  let l19 = (0, import_react51.useId)(), { id: p13 = `headlessui-disclosure-button-${l19}`, disabled: a28 = false, autoFocus: c21 = false, ...n17 } = e9, [o20, r22] = M8("Disclosure.Button"), f21 = ye2(), s20 = f21 === null ? false : f21 === o20.panelId, E13 = (0, import_react100.useRef)(null), T10 = y(E13, t14, o4((i16) => {
    if (!s20) return r22({ type: 4, element: i16 });
  }));
  (0, import_react100.useEffect)(() => {
    if (!s20) return r22({ type: 2, buttonId: p13 }), () => {
...
function Re2(e9, t14) {
  let l19 = (0, import_react51.useId)(), { id: p13 = `headlessui-disclosure-panel-${l19}`, transition: a28 = false, ...c21 } = e9, [n17, o20] = M8("Disclosure.Panel"), { close: r22 } = V4("Disclosure.Panel"), [f21, s20] = (0, import_react100.useState)(null), E13 = y(t14, o4((C11) => {
    a22(() => o20({ type: 5, element: C11 }));
  }), s20);
  (0, import_react100.useEffect)(() => (o20({ type: 3, panelId: p13 }), () => {
    o20({ type: 3, panelId: null });
  }), [p13, o20]);
  let T10 = u17(), [D12, S10] = N2(a28, f21, T10 !== null ? (T10 & i10.Open) === i10.Open : n17.disclosureState === 0), u25 = n2({ open: n17.disclosureState === 0, close: r22 }), m10 = { ref: E13, id: p13, ...x4(S10) }, d14 = K();
...
function c18(d14, l19) {
  let t14 = `headlessui-control-${(0, import_react51.useId)()}`, [p13, s20] = V2(), [n17, a28] = H3(), m10 = a3(), { disabled: r22 = m10 || false, ...o20 } = d14, i16 = n2({ disabled: r22 }), F7 = { ref: l19, disabled: r22 || void 0, "aria-disabled": r22 || void 0 }, T10 = K();
  return import_react101.default.createElement(l2, { value: r22 }, import_react101.default.createElement(s20, { value: p13 }, import_react101.default.createElement(a28, { value: n17 }, import_react101.default.createElement(f6, { id: t14 }, T10({ ourProps: F7, theirProps: { ...o20, children: import_react101.default.createElement(W, null, typeof o20.children == "function" ? o20.children(i16) : o20.children) }, slot: i16, defaultTag: _7, name: "Field" })))));
}
var W3 = Y(c18);
...
function _8(t14, a28) {
  var s20;
  let i16 = a3(), { disabled: e9 = i16 || false, ...p13 } = t14, [n17, T10] = d10((s20 = t14.as) != null ? s20 : d11), l19 = y(a28, T10), [r22, f21] = V2(), m10 = n2({ disabled: e9 }), y10 = n17 === "fieldset" ? { ref: l19, "aria-labelledby": r22, disabled: e9 || void 0 } : { ref: l19, role: "group", "aria-labelledby": r22, "aria-disabled": e9 || void 0 }, F7 = K();
...
// node_modules/@headlessui/react/dist/hooks/use-text-value.js
function s16(c21) {
  let t14 = (0, import_react105.useRef)(""), r22 = (0, import_react105.useRef)("");
  return o4(() => {
    let e9 = c21.current;
    if (!e9) return "";
...
function Et(b14, E13) {
  ...
  let h15 = o4((r22) => {
    switch (r22.key) {
      ...
      case o8.Space:
      case o8.ArrowDown:
        r22.preventDefault(), a28.actions.openListbox({ focus: s20.value ? c12.Nothing : c12.First });
        break;
      case o8.ArrowUp:
        r22.preventDefault(), a28.actions.openListbox({ focus: s20.value ? c12.Nothing : c12.Last });
        break;
    }
  }), I10 = o4((r22) => {
    switch (r22.key) {
...
function _t(b14, E13) {
  ...
  })(), [r22, M12] = Re($6), ne4 = Te(), re4 = y(E13, o20 ? r22 : null, t14.actions.setOptionsElement, O5), q5 = p();
...
function x9(e9, i16 = (t14) => t14) {
  let t14 = e9.activeItemIndex !== null ? e9.items[e9.activeItemIndex] : null, n17 = G2(i16(e9.items.slice()), (s20) => s20.dataRef.current.domRef.current), r22 = t14 ? n17.indexOf(t14) : null;
...
var k10 = { [1](e9) {
  ...
  for (let [s20, l19] of t14.entries()) if (r22.has(l19.id) && (n17.push(s20), r22.delete(l19.id), r22.size === 0)) break;
  if (n17.length > 0) {
    t14 = t14.slice();
    for (let s20 of n17.reverse()) t14.splice(s20, 1);
  }
...
var h11 = class _h extends T3 {
  constructor(t14) {
    ...
    S9(this, "actions", { registerItem: k3(() => {
      let t15 = [], n17 = /* @__PURE__ */ new Set();
      return [(r22, s20) => {
        n17.has(s20) || (n17.add(s20), t15.push({ id: r22, dataRef: s20 }));
    ...
    S9(this, "selectors", { activeDescendantId(t15) {
      ...
      return n17 === null || (s20 = r22[n17]) == null ? void 0 : s20.id;
    }, isActive(t15, n17) {
      var l19;
      let r22 = t15.activeItemIndex, s20 = t15.items;
      return r22 !== null ? ((l19 = s20[r22]) == null ? void 0 : l19.id) === n17 : false;
    }, shouldScrollIntoView(t15, n17) {
    ...
    });
    {
      ...
      this.disposables.add(r22.on(k4.Push, (s20) => {
        !r22.selectors.isTop(s20, n17) && this.state.menuState === 0 && this.send({ type: 1 });
...
var d13 = class _d extends T3 {
  constructor(e9) {
    ...
    p12(this, "selectors", { isPortalled: (e10) => {
      ...
      let l19 = x3(o20), s20 = l19.indexOf(e10.button), r22 = (s20 + l19.length - 1) % l19.length, c21 = (s20 + 1) % l19.length, S10 = l19[r22], m10 = l19[c21];
...
function f19({ id: r22, __demoMode: o20 = false }) {
  let e9 = (0, import_react110.useMemo)(() => d13.new({ id: r22, __demoMode: o20 }), []);
  return c13(() => e9.dispose()), e9;
}
...
function Tt2(E13, O5) {
  var M12;
  let R7 = (0, import_react51.useId)(), { __demoMode: B2 = false, ...T10 } = E13, n17 = f19({ id: R7, __demoMode: B2 }), b14 = (0, import_react111.useRef)(null), t14 = y(O5, T((r22) => {
    b14.current = r22;
  })), [A5, d14, o20, C11, y10] = S3(n17, (0, import_react111.useCallback)((r22) => [r22.popoverState, r22.button, r22.panel, r22.buttonId, r22.panelId], [])), D12 = c6((M12 = b14.current) != null ? M12 : d14), _10 = s3(C11), a28 = s3(y10), u25 = (0, import_react111.useMemo)(() => ({ buttonId: _10, panelId: a28, close: n17.actions.close }), [_10, a28, n17]), f21 = we2(), l19 = f21 == null ? void 0 : f21.registerPopover, c21 = o4(() => {
    var F7, G6;
  ...
  E7(D12, "focus", (r22) => {
    ...
    r22.target !== window && i4(r22.target) && n17.state.popoverState === v9.Open && (c21() || n17.state.button && n17.state.panel && (j11.contains(r22.target) || (G6 = (F7 = n17.state.beforePanelSentinel.current) == null ? void 0 : F7.contains) != null && G6.call(F7, r22.target) || (k13 = (h15 = n17.state.afterPanelSentinel.current) == null ? void 0 : h15.contains) != null && k13.call(h15, r22.target) || (H9 = (I10 = n17.state.afterButtonSentinel.current) == null ? void 0 : I10.contains) != null && H9.call(I10, r22.target) || n17.actions.close()));
  }, true);
  let L7 = A5 === v9.Open;
...
function bt(E13, O5) {
  ...
  let [W5] = (0, import_react111.useState)(() => /* @__PURE__ */ Symbol()), V6 = y(a28, O5, Fe(), o4((e9) => {
    if (!m10) {
...
function Bt2(E13, O5) {
  ...
  let k13 = n2({ open: y10 === v9.Open, close: o20.actions.refocusableClose }), I10 = V(m10 ? j11() : {}, { ref: $6, id: B2, onKeyDown: h15, onBlur: T10 && y10 === v9.Open ? (s20) => {
  ...
  } : void 0, tabIndex: -1, style: { ...d14.style, ...V6, "--button-width": w5(r22, D12, true).width }, ...x4(F7) }), H9 = u21(), fe7 = o4(() => {
    let s20 = c21.current;
    if (!s20) return;
    function e9() {
    ...
    function e9() {
      u(H9.current, { [a21.Forwards]: () => {
        ...
        let p13 = (Be4 = r3(o20.state.button)) != null ? Be4 : document.body, i16 = x3(p13), x10 = i16.indexOf(o20.state.button), S10 = i16.slice(0, x10 + 1), se2 = [...i16.slice(x10 + 1), ...S10];
  ...
  return import_react111.default.createElement(s13, null, import_react111.default.createElement(de5.Provider, { value: B2 }, import_react111.default.createElement(C5, { value: o20.actions.refocusableClose }, import_react111.default.createElement(te, { enabled: b14 ? E13.static || r22 : false, ownerDocument: Q7 }, r22 && C11 && import_react111.default.createElement(f4, { id: f21, ref: a28, features: s5.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: fe7 }), Pe2({ ourProps: I10, theirProps: d14, slot: k13, defaultTag: Rt2, features: Ft2, visible: r22, name: "Popover.Panel" }), r22 && C11 && import_react111.default.createElement(f4, { id: l19, ref: u25, features: s5.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: ae5 })))));
}
var At2 = "div";
function _t2(E13, O5) {
...
function Se3(o20, t14) {
  let e9 = (0, import_react51.useId)(), n17 = a3(), { id: P8 = `headlessui-radiogroup-${e9}`, value: R7, form: D12, name: i16, onChange: c21, by: d14, disabled: a28 = n17 || false, defaultValue: h15, tabIndex: f21 = 0, ...L7 } = o20, T10 = u9(d14), [v11, y10] = (0, import_react112.useReducer)(Ue2, { options: [] }), p13 = v11.options, [k13, G6] = V2(), [I10, F7] = H3(), E13 = (0, import_react112.useRef)(null), m10 = y(E13, t14), b14 = l3(h15), [s20, x10] = b2(R7, c21, b14), g6 = (0, import_react112.useMemo)(() => p13.find((r22) => !r22.propsRef.current.disabled), [p13]), O5 = (0, import_react112.useMemo)(() => p13.some((r22) => T10(r22.propsRef.current.value, s20)), [p13, s20]), l19 = o4((r22) => {
    var U3;
    if (a28 || T10(r22, s20)) return false;
    let S10 = (U3 = p13.find((u25) => T10(u25.propsRef.current.value, r22))) == null ? void 0 : U3.propsRef.current;
    return S10 != null && S10.disabled ? false : (x10 == null || x10(r22), true);
  }), ce3 = o4((r22) => {
  ...
  }), Y4 = o4((r22) => (y10({ type: 0, ...r22 }), () => y10({ type: 1, id: r22.id }))), fe7 = (0, import_react112.useMemo)(() => ({ value: s20, firstOption: g6, containsCheckedOption: O5, disabled: a28, compare: T10, tabIndex: f21, ...v11 }), [s20, g6, O5, a28, T10, f21, v11]), Te5 = (0, import_react112.useMemo)(() => ({ registerOption: Y4, change: l19 }), [Y4, l19]), me5 = { ref: m10, id: P8, role: "radiogroup", "aria-labelledby": k13, "aria-describedby": I10, onKeyDown: ce3 }, Re4 = n2({ value: s20 }), ye4 = (0, import_react112.useCallback)(() => {
...
function Le4(n17, t14) {
  var g6;
  let a28 = (0, import_react51.useId)(), f21 = u4(), h15 = a3(), { id: b14 = f21 || `headlessui-switch-${a28}`, disabled: o20 = h15 || false, checked: s20, defaultChecked: T10, onChange: y10, name: p13, value: c21, form: u25, autoFocus: S10 = false, ...C11 } = n17, _10 = (0, import_react113.useContext)(E12), [L7, R7] = (0, import_react113.useState)(null), G6 = (0, import_react113.useRef)(null), A5 = y(G6, t14, _10 === null ? null : _10.setSwitch, R7), l19 = l3(T10), [d14, r22] = b2(s20, y10, l19 != null ? l19 : false), F7 = p(), [H9, P8] = (0, import_react113.useState)(false), D12 = o4(() => {
...
function b13({ onFocus: n17 }) {
  let [r22, o20] = (0, import_react114.useState)(true), u25 = f17();
  return r22 ? import_react114.default.createElement(f4, { as: "button", type: "button", features: s5.Focusable, onFocus: (a28) => {
    a28.preventDefault();
    let e9, i16 = 50;
    function t14() {
      if (i16-- <= 0) {
...
var De4 = { [0](e9, r22) {
  ...
  let s20 = t14.slice(0, r22.index), f21 = [...t14.slice(r22.index), ...s20].find((u25) => a28.includes(u25));
  if (!f21) return n17;
...
function h14(e9) {
  let r22 = (0, import_react115.useContext)(z3);
  if (r22 === null) {
...
function Q6(e9) {
  let r22 = (0, import_react115.useContext)(V5);
  if (r22 === null) {
    let t14 = new Error(`<${e9} /> is missing a parent <Tab.Group /> component.`);
...
function he2(e9, r22) {
  ...
  let d14 = s20 !== null, u25 = s3({ isControlled: d14 }), T10 = y(r22), [p13, c21] = (0, import_react115.useReducer)(Fe6, { info: u25, selectedIndex: s20 != null ? s20 : t14, tabs: [], panels: [] }), v11 = n2({ selectedIndex: p13.selectedIndex }), m10 = s3(n17 || (() => {
...
var ve2 = "div";
function Ce4(e9, r22) {
  let { orientation: t14, selectedIndex: l19 } = h14("Tab.List"), a28 = y(r22), n17 = n2({ selectedIndex: l19 }), s20 = e9, g6 = { ref: a28, role: "tablist", "aria-orientation": t14 };
  return K()({ ourProps: g6, theirProps: s20, slot: n17, defaultTag: ve2, name: "Tabs.List" });
}
var Me2 = "button";
function Ge2(e9, r22) {
  var Y4, Z4;
  let t14 = (0, import_react51.useId)(), { id: l19 = `headlessui-tabs-tab-${t14}`, disabled: a28 = false, autoFocus: n17 = false, ...s20 } = e9, { orientation: g6, activation: f21, selectedIndex: b14, tabs: d14, panels: u25 } = h14("Tab"), T10 = Q6("Tab"), p13 = h14("Tab"), [c21, v11] = (0, import_react115.useState)(null), m10 = (0, import_react115.useRef)(null), C11 = y(m10, r22, v11);
...
var Ue3 = "div";
function He4(e9, r22) {
  let { selectedIndex: t14 } = h14("Tab.Panels"), l19 = y(r22), a28 = n2({ selectedIndex: t14 }), n17 = e9, s20 = { ref: l19 };
...
function Ne4(e9, r22) {
  var R7, A5, L7, _10;
  let t14 = (0, import_react51.useId)(), { id: l19 = `headlessui-tabs-panel-${t14}`, tabIndex: a28 = 0, ...n17 } = e9, { selectedIndex: s20, tabs: g6, panels: f21 } = h14("Tab.Panel"), b14 = Q6("Tab.Panel"), d14 = (0, import_react115.useRef)(null), u25 = y(d14, r22);
